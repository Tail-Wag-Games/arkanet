defmodule ArkanetWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ArkanetWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ArkanetWeb.Gettext, "errors", msg, opts)
    end
  end
